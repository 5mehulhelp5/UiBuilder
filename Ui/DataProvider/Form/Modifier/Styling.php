...
namespace Cytracon\UiBuilder\Ui\DataProvider\Form\Modifier;

use Magento\Ui\Component\Form\Fieldset;

class Styling extends \Cytracon\UiBuilder\Ui\DataProvider\Form\AbstractModifier
{
                    ...
                    'arguments' => [
                        'data' => [
                            'config' => [
                                ...
                                'template'                        => 'Cytracon_UiBuilder/form/edit/styling',
                                'dataScope'                       => 'data'
                            ]
                        ]
                    ],
    ...
    public function prepareChildren()
    {
        $this->addChildren(
            ...
            [
                'sortOrder'   => 0,
                'displayArea' => 'simply',
                'component'   => 'Cytracon_UiBuilder/js/element/design-simply',
                'links'       => [
